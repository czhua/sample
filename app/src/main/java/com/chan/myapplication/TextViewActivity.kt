...
class TextViewActivity : AppCompatActivity() {
    ...
    val title =
//        "Widely con1144444444444444444444444444444444444444444444444444444444"
...
//        "没有雪的冬季是不完整的，它能将你拉回到童年的欢乐时刻。 游客们对这一特殊规定不怒反赞？村里都是女性，征婚条件却让人望而却步！香港有一位富豪，他手底下有两块地价值两千亿"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<TextView>(R.id.line3_tv).text = title
